// This file include a flattened StateSender from maticnetwork/contracts/StateSender
...
contract StateSender is Ownable {
    ...
    // example : register(RootChainManagerProxyAddress, ChildChainManagerProxyAddress)
