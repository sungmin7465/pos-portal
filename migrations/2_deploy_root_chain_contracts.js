...
module.exports = async (deployer, network, accounts) => {
    ...
    const mintableErc20Predicate = await deployer.deploy(
    ...
    await mintableErc20PredicateProxy.updateAndCall(
        ...
        mintableErc20Predicate.contract.methods
    ...
    await mintableERC721PredicateProxy.updateAndCall(
        ...
        mintableERC721Predicate.contract.methods
            .initialize(accounts[0])
            .encodeABI()
    );
