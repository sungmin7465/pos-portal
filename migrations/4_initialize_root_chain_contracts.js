...
module.exports = async (deployer) => {
    ...
    await RootChainManagerInstance.setStateSender(config.stateSender);
    const stateSenderContract = await StateSender.at(config.stateSender);
    await stateSenderContract.register(
        contractAddresses.root.RootChainManagerProxy,
    ...
    const MintableERC721Type =
        await MintableERC721PredicateInstance.TOKEN_TYPE();
    await RootChainManagerInstance.registerPredicate(
        MintableERC721Type,
        MintableERC721PredicateInstance.address
    );
